...
export default function Contract() {
	...
	const [contractsForCompanyLogged, setContractsForCompanyLogged] = useState<Contract[] | null
	>(null)
		...
		<main className="w-full h-full">
            ...
            <footer className='flex items-center justify-between mb-8'>
               ...
               <p className='flex self-end text-no_black/25 font-bold'>
                  <Copyright size={24} color="rgba(3, 3, 3, 0.25)" weight="bold" /> 2022 - Guilherme Vitória
               </p>
            </footer>
