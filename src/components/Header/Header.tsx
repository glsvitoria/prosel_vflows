	...
	return (
		<header>
			<div className="flex items-center pt-6">
				...
				/>
				<h1 className="uppercase 2xl:text-5xl lg:text-4xl md:text-2xl sm:text-lg xs:text-base text-sm w-full text-center">
					Pagamento de Fornecedor
				</h1>
			</div>

			<ul className="grid sm:grid-cols-2 sm:gap-0 gap-2 border-2 border-no_black/50 rounded-2xl sm:p-6 p-4 xl:text-xl md:text-base sm:text-sm xs:text-base text-sm mt-8 mb-6">
			...
			<div className="w-full border-2 border-no_black/25 h-16 flex items-center justify-center rounded-2xl mb-4">
				...
				<h2 className="lg:text-2xl md:text-xl sm:text-lg">{title}</h2>
			</div>
		</header>
	)
}
